  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="rounded-2xl bg-slate-50 p-8 text-center">
        ...
        <a href="mailto:redactie@nieuwsland.be" className="inline-block rounded-full bg-[#1E3A8A] px-6 py-3 text-sm font-bold text-white transition-all duration-300 hover:scale-105 hover:bg-[#F97316]">
