  ...
  return (
    <section className="border-b border-red-200 bg-red-50">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <LiveBadge />
        <span className="text-xs font-bold uppercase tracking-wide text-red-700">Net Binnen</span>
        <div className="flex flex-1 flex-wrap gap-x-4 gap-y-2 text-sm text-red-900">
          {items.map((item) => (
